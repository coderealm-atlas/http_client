// io_monad_poll_if_legacy.hpp
// Snapshot of io_monad.hpp prior to keep-alive polling changes made in October 2025.
// Retained for historical reference and potential rollback investigations.
